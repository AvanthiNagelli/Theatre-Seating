...
import com.codingtest.theaterseating.model.TheaterSection;
...
public class TheaterSeatingServiceImpl implements TheaterSeatingService {
    ...
    public TheaterLayout getTheaterLayout(String rowLayout) throws NumberFormatException,IndexOutOfBoundsException{
        ...
        String[] rows = rowLayout.split(System.lineSeparator());
        String[] sections;
    ...
    @Override
    public String processTicketRequests(TheaterLayout layout, List<TheaterRequest> requests) {
        ...
        return "successfully proccessed the input request";
    }
